...
class CareersControllerTest < ActionController::TestCase
  ...
  test "should create career" do
    assert_difference('Career.count') do
      post :create, career: { capacity: @career.capacity, description: @career.description, title: @career.title }
    end
  ...
  test "should update career" do
    put :update, id: @career, career: { capacity: @career.capacity, description: @career.description, title: @career.title }
    assert_redirected_to career_path(assigns(:career))
  end
