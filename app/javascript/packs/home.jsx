...
const Home = () => (
  <Frame id="component-home" className="fgs-al" vertical>
    ...
    <Frame className="fgs-al services-projects-beliefs container" vertical>
      <GeneralPost
        image={UserOnPhone}
        typeText="SERVICES"
        ...
        <GeneralPost
          ...
          text={
            <>
              ...
              <br />
              <br />
              We approach most (if not all) new ideas as something to try out and see where it goes. This flexible approach is
              what enables us to get your application up and running quickly, as well as to make improvements whenever needed.
            </>
          }
          link="/about"
        ...
        <GeneralPost
          ...
          text={
            <>
              ...
              technical questions? Whatever it may be, please drop us a line and we'll do our best to answer any questions you may
              have.
              <br />
              <br />
              BiteSite believes strongly in finding a good fit company for a good fit customer. So if we find out we're not right
              for you, we won't pressure you. If we do, we'll be happy to build something you'll truly be excited about.
            </>
          }
          link="/contact"
