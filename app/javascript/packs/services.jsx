  ...
  <div id="component-services">
    <div className="container">
      ...
      <div className="product-management">
        ...
        <div className="product-management-right-align">
          <img src={productManagementImg} alt="product-managment" className="img-right" />
        </div>
      </div>
      <div className="software-development">
        ...
        <div className="software-dev">
          <img src={softwareDevImg} alt="software-dev" className="img-left" />
        </div>
      </div>
      <div className="ux/ui-design">
        ...
        <div className="design-right-align">
          <img src={uxUiDesignImg} alt="uxui-design" className="img-right" />
        </div>
      </div>
    </div>
  </div>
