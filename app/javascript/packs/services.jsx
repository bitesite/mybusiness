  ...
  return (
    <div className="services-component">
      ...
      <DarkBackgroundGeneralPost
        ...
        text={
          <>
            When it comes down to it, custom software simply means software that was built specifically for you. That covers a
            huge area and a lot of times our customers wonder if their project is suitable for us. While we recommend you come in
            and chat with us to see if your project is a fit, we are always excited to work with clients to solve their unique
            problems.
          </>
        }
        link="/contact"
