  ...
  submitComment = (e) => {
    ...
    $.ajax({
      ...
      error: (jqXHR, textStatus, errorThrown) => {
        this.setState({ errors: jqXHR.responseJSON, submitting: false, status: "We're sorry, but there was an error submitting your comment." });
      }
    });
  }
      ...
      <div id='component-comments'>
        ...
        <form className='comments-form'>
          ...
          <div className='actions'>
            <a href='#' className='btn btn-primary' onClick={this.submitComment}>{submitting ? 'Submitting...' : 'Submit'}</a>
          </div>
