...
const AboutPage = () => (
  <div className="about-page fgs-al  fgs-al-v frs-al-g-10">
    <div className="about-page-header fgs-al  fgs-al-v frs-al-g-64">
    ...
    <div className="about-page-beliefs">
      <div className="about-belief-title">Our Beliefs</div>
      <div className="about-belief-content">
        <div className="about-belief-item fgs-al fgs-al-v frs-al-g-10">
          <div className="about-belief-item-title">Transparency</div>
        ...
        <div className="about-belief-item fgs-al fgs-al-v frs-al-g-10">
          <div className="about-belief-item-title">Flexibility</div>
          <div className="about-belief-item-content">
        ...
        <div className="about-belief-item fgs-al fgs-al-v frs-al-g-10">
          <div className="about-belief-item-title">Predictability/ Collaborative Progress/ Iterations</div>
